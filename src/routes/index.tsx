    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-20">
      <div className="absolute inset-0">
        <picture>
          ...
          <source media="(min-width:640px)" srcSet="https://www.goodwood.com/globalassets/.road--racing/road/news/2020/6-june/list-dan-trent-luxury-cars-2020/bmw-i7-2600.jpg?rxy=0.5,0.5" />
          <img src="https://www.goodwood.com/globalassets/.road--racing/road/news/2020/6-june/list-dan-trent-luxury-cars-2020/bmw-i7-2600.jpg?rxy=0.5,0.5" alt="Luxury limousine — premium black exterior and polished finish" className="w-full h-full object-cover" loading="eager" />
        </picture>
